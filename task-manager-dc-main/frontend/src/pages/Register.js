...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const apiUrl = "http://localhost:8080/api/auth/register"; // Replace with your actual endpoint
  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-900 via-black to-purple-900 text-white px-6 py-8">
      <div className="relative z-20 bg-gradient-to-r from-gray-800 via-black-800 to-gray-800 p-8 rounded-3xl shadow-lg w-full max-w-md transform transition duration-500 hover:scale-105">
